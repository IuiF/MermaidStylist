...
- [ ] tests/unit/segment-builder.test.jsを作成
  - [ ] シンプルな2点間パスのテスト
  - [ ] 3制御点パスのテスト
  - [ ] Y調整なしパスのテスト
...
- [ ] 初期Y調整検出ロジック追加
  - [ ] hasInitialYAdjustment判定関数
  - [ ] 短い水平セグメント（shortHorizontal）の生成
  - [ ] 調整後の垂直セグメント生成

### タスク2.3: 最終Y調整対応

- [ ] 最終Y調整検出ロジック追加
  - [ ] needsFinalYAdjustment判定関数
  - [ ] secondVerticalX座標の処理
  - [ ] 2本目の垂直セグメント生成
  - [ ] 最終水平セグメント生成

### タスク2.4: セグメント統合とバリデーション
